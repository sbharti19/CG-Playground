...
export default function Learn() {
    ...
    return ( <div className='bg-dark-layer-1 min-h-screen text-yellow-400 text-center'>
                {/* <div className="text-4xl p-3"></div> */}
                <div className="text-4xl text-white p-3">Growth Tracker</div>
                <div    className="max-w-screen-xl mx-auto mt-20">
                    <div className="m-auto mb-4 max-w-sm p-6 bg-amber-500 border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                        <a href="#">
                        ...
                        <a onClick={() => setLearnModalChange((prev) => ({ ...prev, isOpen: true, type: "goalDigger" }))} className="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white bg-dark-layer-2 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-dark-layer-2 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                            Add &nbsp;
                    ...
                    <div className="m-auto mb-4 max-w-sm p-6 bg-amber-500 border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                        ...
                        <a onClick={() => setVictoryModal((prev) => ({ ...prev, isOpen: true, type: "victoryTracker" }))} className="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white bg-dark-layer-2 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-dark-layer-2 dark:focus:ring-blue-800">
                            Add &nbsp;
                            <svg className="rtl:rotate-180 w-3.5 h-3.5 ms-2" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 14 10">
                                <path stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M1 5h12m0 0L9 1m4 4L9 9"/>
                            </svg>
                    ...
                    <div className="m-auto mb-4 max-w-sm p-6 bg-amber-500 border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                        ...
                        <a onClick={() => setMonthlyProgressModal((prev) => ({ ...prev, isOpen: true, type: "monthlyProgress" }))} className="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white bg-dark-layer-2 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-dark-layer-2 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                            Add &nbsp;
                            <svg className="rtl:rotate-180 w-3.5 h-3.5 ms-2" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 14 10">
                                <path stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M1 5h12m0 0L9 1m4 4L9 9"/>
                            </svg>
